...
extern void        evalProg(ParseTree * tree, string file);
extern void         evalStmt(ParseTree * tree);
extern Value        evalExpr(ParseTree * tree);
extern Value            evalTerm(ParseTree * tree);
extern Value            evalPrimary(ParseTree * tree);
#endif /* PARSE_H_ */
